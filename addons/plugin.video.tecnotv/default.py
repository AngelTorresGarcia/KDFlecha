...
SOURCES = [{"title": "Tecnotv", "url": "https://addon.spinoff.link/index.xml", "icon": "https://imgur.com/5ffQASy.png", "fanart": "https://imgur.com/svKRtVq.jpg",}]
...
def addon_log(string, level=xbmc.LOGDEBUG):
    if debug == 'true':
        xbmc.log("[plugin.video.tecnotv-{0}]: {1}".format(addon_version, string), LOGINFO)
    else:
        xbmc.log("[plugin.video.tecnotv-{0}]: {1}".format(addon_version, string), level)
